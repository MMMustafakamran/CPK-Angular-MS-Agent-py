...
This guide starts from the provider in the [Angular quickstart](/angular/ms-agent-python) and
...
- [Runnable chat examples](/angular/ms-agent-python/features#agentic-chat)
